...
const CGFloat MJRefreshFastAnimationDuration = 1;
const CGFloat MJRefreshSlowAnimationDuration = 1;
...
NSString *const MJRefreshHeaderRefreshingText = @"心急吃不到热豆腐喲...";
...
NSString *const MJRefreshBackFooterRefreshingText = @"客官,您稍等...";
